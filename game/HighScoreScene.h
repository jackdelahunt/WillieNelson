...
//        }
        ...
        * ----------------- */
...

        {
            ...
            text->set_font("Sansation_Regular");
            text->set_text("1.   " + std::to_string(ScoreComponent::Active()->m_scores[0]), sf::Color::White, 50);
...

        {
            ...
            auto text = text_entity->add_component<WillieNelson::TextComponent>();
            text->set_font("Sansation_Regular");
            text->set_text("2.   " + std::to_string(ScoreComponent::Active()->m_scores[1]), sf::Color::White, 50);
...

        {
            ...
            auto text = text_entity->add_component<WillieNelson::TextComponent>();
            text->set_font("Sansation_Regular");
            text->set_text("3.   " + std::to_string(ScoreComponent::Active()->m_scores[2]), sf::Color::White, 50);
